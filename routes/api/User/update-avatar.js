...
Route.post(
    ...
    async function (req, res, next) {
        try {
            ...
            let new_fileName = `userimage${extra}${timestamp}`;
            ...
            let avatar = `${s3FileURL}bikeapp/userimages/${new_fileName}${extractedfileName1}`;
            ...
            let params = {
                ...
                Key: `bikeapp/userimages/${new_fileName}${extractedfileName}`,
                Body: file.buffer,
